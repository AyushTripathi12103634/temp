      ...
      <nav className="navbar">
        <div className="nav-container">
          ...
          <ul className={click ? "nav-menu active" : "nav-menu"}>
            ...
            <li className="nav-item">
              <NavLink to="/about" className="nav-links" onClick={() => setClick(false)}>
                About
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink to="/join" className="nav-links" onClick={() => setClick(false)}>
                Join
              </NavLink>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              {username ? (
                <NavLink to="/profile" className="nav-links" onClick={() => setClick(false)}>
                  {username}
                </NavLink>
              ) : (
                <NavLink to="/login-signup" className="nav-links" onClick={() => setClick(false)}>
                  Login
                </NavLink>
              )}
            </li>
