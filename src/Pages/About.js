            ...
            <div className='new-about-card'>
              ...
              <div className='new-about-card-info'>
                ...
                <div className='new-about-card-icons'>
                  <Link to="https://www.linkedin.com/in/ayush-tripathi-039a20220" target='_blank'>
                    <BiLogoLinkedin className='new-about-logo' />
                  </Link>
                  <Link to="https://www.github.com/ayushtripathi12103634" target='_blank'>
          ...
          <div className='new-about-main-card'>
            <div className='new-about-card'>
              ...
              <div className='new-about-card-info'>
                ...
                <h6>Full Stack Developer</h6>
                <div className='new-about-card-icons'>
                  <Link to="https://www.linkedin.com/in/mohak-tiwari-b78198226/" target='_blank'>
                    <BiLogoLinkedin className='new-about-logo' />
                  </Link>
